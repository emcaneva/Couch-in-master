class AccommodationsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @accommodation.update(accommodation_params)
        format.html { redirect_to @accommodation, notice: 'Se ha creado un nuevo hospedaje.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to accommodations_url, notice: 'Se ha eliminado el hospedaje.' }
  ...
  private
    ...
    def accommodation_params
      params.require(:accommodation).permit(:titulo, :lugar, :informacion, :descripcion, :foto ,:accommodation_type_id) 
    end
end
