...
class AccommodationsControllerTest < ActionController::TestCase
  ...
  test "should create accommodation" do
    assert_difference('Accommodation.count') do
      post :create, accommodation: { descripcion: @accommodation.descripcion, foto: @accommodation.foto, informacion: @accommodation.informacion, lugar: @accommodation.lugar, titulo: @accommodation.titulo }
    end
  ...
  test "should update accommodation" do
    patch :update, id: @accommodation, accommodation: { descripcion: @accommodation.descripcion, foto: @accommodation.foto, informacion: @accommodation.informacion, lugar: @accommodation.lugar, titulo: @accommodation.titulo }
    assert_redirected_to accommodation_path(assigns(:accommodation))
  end
